...
public class FollowingRequest {
     ...
     * @param lastFollowee the alias of the last followee that was returned in the previous request (null if
     *                     there was no previous request or if no followees were returned in the
     *                     previous request).
     */
    public FollowingRequest(AuthToken authToken, String followerAlias, int limit, User lastFollowee) {
     ...
     */
    public void setLastFollowee(User lastFolloweeAlias) {
        this.lastFollowee = lastFollowee;
    }
}
