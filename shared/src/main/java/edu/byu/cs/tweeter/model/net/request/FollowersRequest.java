...
public class FollowersRequest {
     ...
     * @param lastFollower the alias of the last followee that was returned in the previous request (null if
     *                     there was no previous request or if no followees were returned in the
     *                     previous request).
     */
    public FollowersRequest(AuthToken authToken, String followeeAlias, int limit, User lastFollower) {
